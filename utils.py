...
def get_data_loader(dataset, train_set, train_batch_size, shuffle=True):
    ...
    if train_set == True:
        ...
        train_data = dataset
        train_loader = DataLoader(dataset=train_data, batch_size=train_batch_size, shuffle=shuffle,drop_last=True, num_workers=0)
        return train_loader
